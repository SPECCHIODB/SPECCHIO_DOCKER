...
-- LS 26/05/26: ADDED LIMIT 1 to avoid crashing in db container startup
...
INSERT INTO `specchio`.`taxonomy` (`attribute_id`, `name`, `description`, `parent_id`) VALUES ((select `attribute_id` from `specchio`.`attribute` where name = 'Basic Target Type'), 'Roof (Roofing Cardboard)', 'Tar coated roofing paper', (select taxonomy_id from `specchio_temp`.`temp_tax_table` where attribute_id = (select `attribute_id` from `specchio`.`attribute` where name = 'Basic Target Type') and name like 'Roof' and parent_id is not null LIMIT 1));
...
-- tarps
INSERT INTO `specchio`.`taxonomy` (`attribute_id`, `name`, `description`, `parent_id`) VALUES ((select `attribute_id` from `specchio`.`attribute` where name = 'Basic Target Type' LIMIT 1), 'Black Tarp', 'Black reference tarp', (select taxonomy_id from `specchio_temp`.`temp_tax_table` where attribute_id = (select `attribute_id` from `specchio`.`attribute` where name = 'Basic Target Type' LIMIT 1) and name like 'Reference Material' LIMIT 1));
INSERT INTO `specchio`.`taxonomy` (`attribute_id`, `name`, `description`, `parent_id`) VALUES ((select `attribute_id` from `specchio`.`attribute` where name = 'Basic Target Type' LIMIT 1), 'Grey Tarp', 'Grey reference tarp', (select taxonomy_id from `specchio_temp`.`temp_tax_table` where attribute_id = (select `attribute_id` from `specchio`.`attribute` where name = 'Basic Target Type' LIMIT 1) and name like 'Reference Material' LIMIT 1));
INSERT INTO `specchio`.`taxonomy` (`attribute_id`, `name`, `description`, `parent_id`) VALUES ((select `attribute_id` from `specchio`.`attribute` where name = 'Basic Target Type' LIMIT 1), 'White Tarp', 'White reference tarp', (select taxonomy_id from `specchio_temp`.`temp_tax_table` where attribute_id = (select `attribute_id` from `specchio`.`attribute` where name = 'Basic Target Type' LIMIT 1) and name like 'Reference Material' LIMIT 1));
